...
1. Confirm HEAD, worktree status, normal and cached diffs, `package.json`, `public/manifest.json`, `vite.config.ts`, `tsconfig.json`, and the requested paths.
...
| Boundaries | `src/core/`, `src/extension/`, Chrome APIs, browser APIs, adapters |
...
| Build and distribution | Vite inputs, manifest copy, generated assets, `dist/extension/`, version |
